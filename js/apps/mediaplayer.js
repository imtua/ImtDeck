window.initMediaPlayerApp = function () {
    // Define your 20 tracks (place your audio files in assets/music/)
    const playlist = [
        { title: "American Boy", artist: "Kanye West", src: "assets/musics/track1.mp3", cover: "assets/music_covers/track1.png" },
        ...
        { title: "Ginseng Strip 2002", artist: "Yung Lean", src: "assets/musics/track12.mp3", cover: "assets/music_covers/track12.png" },
        { title: "Headlock", artist: "Imogen Heap", src: "assets/musics/track13.mp3", cover: "assets/music_covers/track13.png" },
        { title: "I Wonder", artist: "Kanye West", src: "assets/musics/track14.mp3", cover: "assets/music_covers/track14.png" },
        { title: "Ice", artist: "Zertal", src: "assets/musics/track15.mp3", cover: "assets/music_covers/track15.png" },
    ...
    <div class="player-container">
      ...
      <!-- Right: Scrollable Playlist (20 tracks) -->
  ...
  `;
    ...
    wm.createWindow('mediaplayer', 'Media Player — ImtOS Studio', playerHTML, { width: '740px', height: '440px' });
