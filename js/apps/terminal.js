window.initTerminalApp = function () {
    ...
    <div class="terminal-container">
      <div class="terminal-output" id="term-output">
        <div class="term-line welcome">ImtOS System Shell v1.0.0</div>
    ...
    setTimeout(() => {
        ...
        function handleCommand(cmd) {
          ...
          `, 'info');
                ...
                case 'bio':
                    appendLine('Crafting web operating systems, brutalist aesthetics, and high-performance digital tools.', 'info');
                    break;

                case 'projects':
                    appendLine('1. ZETRO — Brutalist Luxury Apparel<br/>2. Synthetics — Digital Web Architecture<br/>3. ImtOS — Corporate Studio WebOS', 'highlight');
                    break;
          ...
          `, 'easter-egg');
                ...
                case 'secret':
                    appendLine('🔓 [Easter Egg Discovered]: You unlocked root access to ImtOS!', 'success');
                    break;
