window.initWidgetsApp = function () {
    ...
    <div class="widgets-container">
      <!-- Widget 1: Live Studio Clock & Date -->
      ...
      <!-- Widget 3: Quick Desktop Scratchpad -->
      ...
      <!-- Widget 4: Studio Quote / Status -->
      <div class="widget-card quote-card">
        <div class="widget-label">STUDIO STATUS</div>
        <p class="quote-text">"Simplicity is about subtracting the obvious and adding the meaningful."</p>
        <span class="quote-author">— ImtOS Core Engine</span>
      </div>
    </div>
  `;
    ...
    setTimeout(() => {
        ...
        // 3. Simulated Live System Metrics
